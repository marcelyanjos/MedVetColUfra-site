const data = [
  {
    ...
    Como os números não mentem e mostram que o brasileiro é um apaixonado por pets, a pergunta que paira no ar é: porque, então, mais de 20 milhões de bichinhos estão abandonados nas ruas e tornam-se alvos de maus-tratos constantes, vítimas da fome e de atropelamentos.
    
    Esta triste realidade pode ser invertida com conscientização da sociedade da importância da adoção responsável, que é um ato de amor que pode salvar vidas de pets carentes. Por isso, no post de hoje, separamos oito motivos para você adotar um deles. Acompanhe:
    
    1. Adotar é uma forma de trazer um novo conceito para a sua vida
    Gratidão: é um dos principais valores, entre outros ensinamentos, que a adoção de um pet traz para a vida do tutor. A partir de uma adoção as pessoas podem entender melhor o que significa ser grato, pois é exatamente este sentimento que o cão consegue transmitir.
    
    2. Diminui o número de animais abandonados nas ruas e em abrigos
    Todos os pets merecem uma vida digna, regada com muito amor e proteção. Por esse motivo, ao concretizar uma adoção responsável você está proporcionado uma vida de mais qualidade para o pet.

    Além disso, ao adotar o animal de um abrigo você estará, automaticamente, salvando mais de uma vida, pois o espaço do seu novo melhor amigo será disponibilizado a outro animal de rua que será resgatado.
    
    3. Ter um pet em casa = felicidade para o lar
    Do mesmo modo em que você pratica o bem para o pet, ele também se esforça para proporcionar momentos de alegria para sua vida. Na verdade, o sentimento de felicidade estará
    presente para a família toda.
    
    4.Você estará resgatando uma vida
    Como os pets de rua estão vulneráveis a diversos tipos de maus-tratos e riscos de vida, ao adotar, você estará garantindo que ele tenha uma oportunidade de sobreviver e de desfrutar de uma vida feliz e saudável com alguém que o ama.
    
    5. Ter um pet em casa faz bem para a saúde
    ...
    6. Economiza o seu dinheiro
    Quando você adota você economiza dinheiro, afinal, não vai comprar nada. Outra vantagem: como a maioria dos pets que são adotados são Sem Raça Definida (SRD), eles são mais resistentes que os de raça e por esse motivo ficam menos doentes. Assim, consequentemente, não geram tanta
    despesa.
    
    7. Não terá surpresas, caso opte pela adoção de um pet adulto
    Apesar de muitas pessoas terem receio de adotar um pet adulto por acreditarem que terão dificuldades da adaptação em seu novo lar, pensar dessa forma é um erro.
    
    Uma vez que os animais acolhidos nessa fase são mais gratos por serem adotados adultos. Também não haverá surpresas, como crescer mais que o esperado, chorar durante a noite ou apresentar um comportamento diferente de quando era filhote. Além disso, a maioria já vem castrada.
    
    8. Você não financia o sofrimento do mercado de pets
...
VACINAÇÃO DE CÃES:
     ...
     A vacinação dos cães é um caso de saúde pública. O “efeito rebanho” causado pela vacinação faz com que quanto mais animais forem vacinados, menor seja a chance de doenças comuns tomarem grandes proporções. Por isso, é de suma importância manter o cartão de vacinação do seu amigo atualizado.
...
Você sabe contra quais doenças o seu animal estará protegido? Confira nessa lista abaixo:

V8 (óctupla) e V10 (déctupla):

– Cinomose: é uma virose que ataca cães, afetando órgãos respiratórios, com febre e secreções purulentas, e também o sistema nervoso. É uma doença de grande letalidade.

– Parvovirose: é uma virose que infecta cães, afeta o trato digestório e causa diarreia, febre e imunossupressão. Também é uma doença de alta letalidade.

– Hepatite Infecciosa Canina: é uma virose que ataca o fígado dos cães, causando febre e diarreia sanguinolenta. Em casos mais graves, pode afetar o Sistema Nervoso e causar a morte.

– Adenovirose: é uma virose que causa sinais respiratórios graves nos cães, como tosse seca e constante, espirros, febre, secreções, etc. Se não for tratada, pode evoluir para pneumonia e levar a morte do animal.
...
– Parainfluenza: é uma virose que causa sinais respiratórios como tosse, secreções e febre.
...
Além de necessitarem de reforço anual da antirrábica a partir dos 4 meses de idade, os gatos também devem tomar outras vacinas. O calendário de vacinação felino inicia aos 2 meses e deve conter um reforço aos 3 meses. A partir daí, o reforço é anual, para uma imunização eficaz.
...
– Clamidiose: é uma doença bacteriana que afeta os olhos dos animais, causando conjuntivite e rinite.

V5 (Quíntupla):

– Todas as anteriores

– Leucemia Felina (FeLV): é uma grave doença viral comparada à Leucemia humana. Provoca imunossupressão no animal, tornando-o susceptível a outras doenças
