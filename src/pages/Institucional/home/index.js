    ...
    <Box style={{ minHeight: "250px", display:'flex', flexDirection:'column', alignItems:'center' }}>
      ...
      >
        ...
        >
          ...
          {<p/>}
          Ao adotar, você ajuda a
          reduzir o número de cães e gatos abandonados. Geralmente os animais de
          rua ou de abrigos já passaram por muito sofrimento e tudo o que eles
          precisam é de um bom lar para serem felizes de verdade.
        </Typography>
      </Box>
      <CardCarrousel />
    </Box>
