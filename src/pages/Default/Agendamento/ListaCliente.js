...
function CheckClient(props) {
    ...
    const handleSearchClient = (event) => {
        ...
        api
            .get(
                `/api/clientes?nome=${clientInfo.nome
            ...
            .then((clientResponse) => {
                ...
                if (clients.length === 1) {
                    ...
                    alert("Mais de um cliente encontrado com os mesmos dados. Verifique a base de dados.");
                    setAgendamentos([]);
                    setShowTable(true);
                }
            })
                ...
                <Grid item sx={{ mt: 2 }}>
                    {isLoading ? (
                        ...
                        <>
                            ...
                            <Button variant="contained" onClick={handleClearSearch} sx={{mt:2}}>
                                Voltar
                            </Button>
                        </>
                    )}
