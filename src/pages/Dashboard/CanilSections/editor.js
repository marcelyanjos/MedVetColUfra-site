...
import { getCanilId, populateCanil } from '../../../services/cms'
...
export default function Article() {
  ...
  useEffect(() => {
    if (id) {
      getCanilId(setFormData, id, setIsLoading, setPublishedAtDate)
    } else {
  ...
  const handleSubmit = async (e) => {
    ...
    await populateCanil(navigate, formData, setFormData, publishedAtDate, id)
  }
